const PRICES = {
  ...
  CREATIVE: {
    AI_GAMES: {
      ...
      AI_STAR_GREETING: { name: 'Поздравление от ИИ-звёзд', price: 10000, desc: 'На ваш праздник заглянут звёзды! Получите порцию юмора в эксклюзивных видео-поздравлениях от ИИ-копий известных личностей.', requiresScreen: true }
    },
