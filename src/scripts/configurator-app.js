...
allModals.forEach(modal => {
    ...
    modal.addEventListener('click', (e) => {
        ...
        // ... (ДАЛЬШЕ ИДЕТ ВЕСЬ ОСТАЛЬНОЙ КОД КАЛЬКУЛЯТОРА ВЕДУЩЕГО БЕЗ ИЗМЕНЕНИЙ) ...
        // Я удалил из него только те части, которые мы вынесли в глобальную область
        ...
        function initializeApp() {
            ...
            selection = { hostHours: '6', projectorNeeded: false, techOption: 'STANDARD', creative: { ai_games: {}, eminem_tracks: {} }, totalPrice: 0, venueType: 'standard', guestCount: '1-40', venueGear: 'none', venueScreen: 'no', photographerNeeded: 'no', photographerHours: 1, additionalRetouch: 0 };
            setupRetouchTooltip();
